...
function writePassword() {
    ...
    do {
        var useLowerCase = confirm("Do you your password to include lower case letters?")
        var useUpperCase = confirm("Do you your password to include upper case letters?")
        var useNumbers = confirm("Do you your password to include numbers?")
